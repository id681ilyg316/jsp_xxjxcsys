  	...
  	<div class="container" style="width:100%;">
  		<div class="panel panel-success">
  			...
  			<div class="panel-body">
  				...
  				<form action="CheckoutServlet?action=vip" style="font-weight:bold;">
				...
				<form action="CheckoutServlet?action=cash" style="font-weight:bold;margin-top:53px;font-size:20px;">
